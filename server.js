...
function navTo(page,el){
  var navEl=el||document.querySelector('.nav-item[onclick*="'+page+'"]')
  if(!navEl)navEl=document.querySelector('.nav-item')
  P(page,navEl)
}
...
async function importJobsExcel(input){
  ...
  try{
    ...
    modal('Import '+validRows.length+' Jobs', h, async function(){
      ...
      if(!confirm('Ready to import. Found '+existingCount+' existing jobs in database.\nIf this number seems wrong, click Cancel.\n\nContinue?'))return
...
async function pgNewJob(){
  ...
  <div>
    <div class="card">
      ...
      <div class="fg"><label class="fl">Expected On Site</label><input class="fi" type="date" id="nj-eos"></div></div>
      <div class="three"><div class="fg"><label class="fl">Next Visit</label><input class="fi" type="date" id="nj-nvd"></div>
